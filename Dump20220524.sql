...
CREATE TABLE `itenspedido` (
  ...
  `QTDE` double(10,2) DEFAULT NULL,
  `PRECO` double(10,2) DEFAULT NULL,
  PRIMARY KEY (`HANDLE`,`NUMERO`)
...
INSERT INTO `itenspedido` VALUES (1,123,1,0.00,5.00),(2,123,2,0.00,10.00);
...
INSERT INTO `pedidos` VALUES (2,123,15.00);
...
INSERT INTO `produtos` VALUES (37,2,'arroz','UN'),(38,1,'teste','UN');
...
-- Dump completed on 2022-05-24 23:21:21
